...
const Icon: FC<GeneralIconProps> = ({ classes, path, width = 16 }) => {
  return (
...
export const CancelIcon: FC<IconProps> = ({ classes }) => (
  <Icon
    classes={classes}
...
export const DeleteIcon: FC<IconProps> = ({ classes }) => (
  <Icon
    classes={classes}
...
export const EditIcon: FC<IconProps> = ({ classes }) => (
  <Icon
    classes={classes}
...
export const SaveIcon: FC<IconProps> = ({ classes }) => (
  <Icon
    classes={classes}
